...
Run these files for store-release confidence after automated tests pass.
...
Do not mark browser testing complete unless the unpacked extension has been loaded and tested in Microsoft Edge.
