...
TabPack saves grouped tabs from the current browser window into local files on your device. Each tab group becomes a folder, and each supported HTTP or HTTPS tab is exported in the same left-to-right order shown in the tab strip.
